...
<img src="docs/images/branch.png" style="max-width:50%;">
...
<img src="docs/images/tag.png" style="max-width:50%;">
...
1. Select the release tag on the `Changes` tab: <img src="docs/images/run-on-tag.png" style="max-width:50%;">
1. Add an `env.DISABLE_IMAGE_DISAMBIGUATION_SUFFIX` environment variable on the
   `Parameters` tab: <img src="docs/images/run-with-param.png" style="max-width:50%;">
1. click `Run Build`
